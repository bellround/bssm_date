...
def get_min_node(node):
    ...
    while current is not None:
        current = node.left # "더 작은 값 찾으러 왼쪽으로 이동!"
...
#         print("2. 데이터 탐색")
#         print("3. 데이터 삭제")
#         print("4. 현재 트리 출력 (중위 순회)")
#         print("0. 프로그램 종료")
        
#         choice = input("메뉴를 선택하세요: ")
        
#         if choice == '1':
#             val = int(input("삽입할 숫자를 입력하세요: "))
#             root = insert_node(root, val)
#             print(f"[{val}] 삽입 완료!")
#         elif choice == '2':
#             val = int(input("탐색할 숫자를 입력하세요: "))
#             if search_rec(root, val):
#                 print(f"탐색 성공! 트리에 [{val}]이(가) 존재합니다.")
#             else:
#                 print(f"탐색 실패! 트리에 [{val}]이(가) 없습니다.")
#         elif choice == '3':
...
#                 print(f"[{val}] 삭제 완료!")
#             else:
#                 print(f"[{val}]이(가) 트리에 존재하지 않아 삭제할 수 없습니다.")
#         elif choice == '4':
#             print("현재 트리 (오름차순): ", end="")
#             if root is None:
#                 print("트리가 비어있습니다.")
#             else:
#                 inorder (root)
...
inorder(root)
print()
if search_rec(root, 40):
    print(f"탐색 성공! 트리에 [{40}]이(가) 존재합니다.")
else:
    print(f"탐색 실패! 트리에 [{40}]이(가) 없습니다.")
    
if search_rec(root, 99):
    print(f"탐색 성공! 트리에 [{99}]이(가) 존재합니다.")
else:
    print(f"탐색 실패! 트리에 [{99}]이(가) 없습니다.")

if search_rec(root, 20):
    root = delete_node(root, 20)
    print(f"[{20}] 삭제 완료!")
inorder(root)

if search_rec(root, 80):
    root = delete_node(root, 80)
    print(f"[{80}] 삭제 완료!")
inorder(root)

if search_rec(root, 30):
